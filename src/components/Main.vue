...
.btn__more:link {
  ...
  padding: 5px 50px;
  border-radius: 3px;
  box-shadow: 0px 4px 4px rgba(202, 199, 199, 0.25);
  border-radius: 3px;
  margin: 100px 0;
}
...
.btn__more:hover {
  opacity: 0.5;
  background-color: rgba(100, 43, 43, 0.445);
}
...
.best__item {
  ...
  width: 100%;
  height: 260px;
  background-color: rgba(255, 255, 255, 1.65);
  border-radius: 8px;
  display: flex;
  flex-direction: column;
